...
const Header = ({ navigation, onPress, text, icon, busqueda = false, carrito = false, agregarDirec = false }) => {
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                {agregarDirec ?
                    ...
                    <TouchableOpacity onPress={() => nav.navigate('AgregarDireccion')} style={styles.btnCarrito}>
